...
export function sortBoardMembers<T extends { position?: string | null }>(membersList: T[]): T[] {
  return [...membersList].sort((a, b) => getBoardPositionRank(a.position) - getBoardPositionRank(b.position));
}
