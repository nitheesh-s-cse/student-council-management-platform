  ...
  return (
    <div>
      ...
      {tasks.length === 0 ? (
        ...
        <div className="mt-8 flex w-full max-w-full snap-x snap-mandatory gap-3 overflow-x-auto pb-4 sm:grid sm:grid-cols-2 lg:grid-cols-5">
          {KANBAN_COLUMNS.map((col) => (
            <div
              ...
              className="w-[85vw] max-w-[320px] shrink-0 snap-center rounded-xl border border-[var(--border)] bg-[var(--surface-muted)] p-3 box-border sm:w-full sm:max-w-none sm:min-w-[200px]"
            >
